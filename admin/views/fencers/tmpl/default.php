  ...
  <table class="adminlist">
	<thead>
	  <tr>
        ...
        <th>
          <?php echo JText::_('BFA Number'); ?>
        </th>
        <th>
          <?php echo JText::_('Year of Birth'); ?>
        </th>
        <th>
    ...
    <?php $link = JRoute::_('index.php?option=com_nwjs&view=fencer&layout=edit&id=' .
                            $row->id); ?>
      <tr class="row<?php echo $i % 2; ?>">
        ...
        <td>
          <a href="<?php echo $link; ?>"><?php echo $row->surname . ", ", $row->forename; ?></a>
        </td>
        <td>
          <?php echo $row->BFA_number; ?>
        </td>
        <td>
          <?php echo $row->year_of_birth; ?>
        </td>
        <td>
          <?php echo $row->club; ?>
        </td>
